...
dot.node('GlobalAveragePooling1D', 'GlobalAveragePooling1D\n(16, 64)', shape='box', style='filled', fillcolor=colors['GlobalAveragePooling1D'])
dot.node('Concatenate', 'Concatenate\n(16, 128)', shape='box', style='filled', fillcolor=colors['Concatenate'])
