...
dot.node('MaxPooling1D', 'MaxPooling1D (pool=2)\n(None, 6, 64)', shape='box', style='filled', fillcolor=colors['MaxPooling1D'])
dot.node('SimpleRNN_1', 'SimpleRNN (64 units)\n(None, 6, 64)\n8,256', shape='box', style='filled', fillcolor=colors['SimpleRNN'])
dot.node('MultiHeadAttention', 'MultiHeadAttention (4 heads)\n(None, 6, 64)\n66,368', shape='box', style='filled', fillcolor=colors['MultiHeadAttention'])
dot.node('SimpleRNN_2', 'SimpleRNN (64 units)\n(None, 64)\n8,256', shape='box', style='filled', fillcolor=colors['SimpleRNN'])
